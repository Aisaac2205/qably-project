...
Create exactly one entry per test declaration you find: an "it(...)" or "test(...)" call (vitest/jest), a "@Test" annotated method (JUnit), or a "def test_..." function (pytest). Ignore helper functions, fixtures, and non-test declarations.
...
- vitest/jest: the enclosing describe chain joined by " > ", followed by the it/test title.
