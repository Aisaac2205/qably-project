  ...
  return (
    <div className="flex flex-col px-4 py-6 sm:px-6">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-5 text-3xl font-bold tracking-tight text-default">{t('modules.integrations.title')}</h1>
        <p className="mt-1 text-sm text-muted">{t('modules.integrations.subtitle')}</p>
