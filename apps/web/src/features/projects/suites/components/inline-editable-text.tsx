  ...
  if (!isEditing) {
    return (
      <button
        ...
        className="min-w-0 max-w-full truncate text-left font-semibold text-sm hover:text-primary hover:bg-surface-hover/80 rounded px-1.5 py-0.5 -mx-1.5 transition-colors text-default cursor-text"
