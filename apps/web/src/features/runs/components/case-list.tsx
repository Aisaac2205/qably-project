        ...
        {cases.map((c) => {
          ...
          return (
            <button
              ...
              className={`w-full text-left px-3 py-2.5 flex items-center gap-2 transition-colors hover:bg-primary/5 focus-visible:outline-2 focus-visible:outline-primary ${
                isSelected
