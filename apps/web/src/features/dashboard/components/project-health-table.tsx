  ...
  return (
    <Card className="col-span-1 border border-border/80 flex flex-col justify-between">
      <CardHeader className="flex flex-row items-center justify-between pb-4 p-5">
        <CardTitle className="text-sm font-semibold text-default">Project health</CardTitle>
        <Link
          href="/projects"
        ...
        <table className="w-full text-left border-collapse min-w-[400px]">
          <thead>
            <tr className="border-b border-border bg-canvas/30">
              <th className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground px-5 py-3">Project</th>
              <th className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground px-3 py-3">Health</th>
              <th className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground px-3 py-3">Last run</th>
              <th className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground px-3 py-3 text-center">Suites</th>
              <th className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground px-5 py-3 text-center">AI pending</th>
            </tr>
          </thead>
